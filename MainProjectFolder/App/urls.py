...
urlpatterns = [
    ...
    #----------------CHAT
    path('GetChatMessagesView/', views.GetChatMessagesView.as_view(), name='GetChatMessagesView'),
    path('AddChatMessageView/<int:post_id>/', views.AddChatMessageView.as_view(), name='AddChatMessageView'),
    path('DeleteYourChatMessageView/<int:pk>/delete/', views.DeleteYourChatMessageView.as_view(), name='DeleteYourChatMessageView'), 
