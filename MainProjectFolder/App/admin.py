...
@admin.register(MatatizoYaWateja)
class MatatizoYaWatejaAdmin(ImportExportModelAdmin):
    list_display = ["id","JinaLaMteja","phone","email","Mkoa","Wilaya","JinaLaTatizo", "Created","Updated"]
    list_filter =["Created","Wilaya"]
    search_fields = ["JinaLaMteja"]


@admin.register(NotepadMatatizo)
class NotepadMatatizoAdmin(ImportExportModelAdmin):
    list_display = ["id","Tatizo","NambaYaTatizo","Created","Updated"]
    list_filter =["Created"]
    search_fields = ["Tatizo","NambaYaTatizo"]

@admin.register(NotepadMikoa)
class NotepadMikoaAdmin(ImportExportModelAdmin):
    list_display = ["id","JinaLaMkoa","NambaYaMkoa","Created","Updated"]
    list_filter =["Created"]
    search_fields = ["JinaLaMkoa","NambaYaMkoa"]
...
class ChatMessageAdmin(ImportExportModelAdmin):
    list_display = ["id","MyPostID", "post","sender","created_at", "message"]
    list_filter =["created_at"]
    search_fields = ["post"]

@admin.register(InformUsers)
class InformUsersAdmin(ImportExportModelAdmin):
    list_display = ["id","Title", "SentMessage","post_date"]
...
@admin.register(WatejaWote2)
class WatejaWote2Admin(ImportExportModelAdmin):
