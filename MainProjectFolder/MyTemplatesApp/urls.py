...
urlpatterns = [
    ...
    #-------------------------NOTEPAD-------------
    path('search_MatatizoYaWateja_autocomplete/', views.search_MatatizoYaWateja_autocomplete, name='search_MatatizoYaWateja_autocomplete'),
    path('search_NotepadMikoa_autocomplete/', views.search_NotepadMikoa_autocomplete, name='search_NotepadMikoa_autocomplete'),
    path('search_NotepadMatatizo_autocomplete/', views.search_NotepadMatatizo_autocomplete, name='search_NotepadMatatizo_autocomplete'),
    path('AddNewMatatizoYaWateja/', views.AddNewMatatizoYaWateja, name='AddNewMatatizoYaWateja'),
    path('AllMatatizoYaWateja/', views.AllMatatizoYaWateja, name='AllMatatizoYaWateja'),
    path('UpdateNewMatatizoYaWateja/<int:id>/', views.UpdateNewMatatizoYaWateja, name='UpdateNewMatatizoYaWateja'),
    path('deleteMatatizoYaWateja/<int:id>/', views.deleteMatatizoYaWateja, name='deleteMatatizoYaWateja'),
    path('TatizoStatsView/', views.TatizoStatsView, name='TatizoStatsView'),
    path('MikoaStatsView/', views.MikoaStatsView, name='MikoaStatsView'),
    path('WilayaStatsView/<str:mkoa_name>/', views.WilayaStatsView, name='WilayaStatsView'),
    path('TatizoNdaniYaWilayaStatsView/<str:mkoa_name>/<str:wilaya_name>/', views.TatizoNdaniYaWilayaStatsView, name='TatizoNdaniYaWilayaStatsView'),




    path('InformUsersPage/', views.InformUsersPage, name='InformUsersPage'),
