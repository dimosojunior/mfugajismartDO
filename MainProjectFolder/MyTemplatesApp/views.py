...
def Tuma_KumbushoLaChanjo_Kwa_Wote(request):
    ...
    for user in users:
        ...
        subject = "Mfugaji Smart"
        if selected_chanjo and time_left == 0 and is_red == True:
            #print("WELLLLLL")
            ...
            #mahesabu ya kuongeza Umri wa kuku
            ...
            user.UmriWaKukuKwaSiku = UmriWaKukuKwaSiku + remaining_days_1
            ...
            message = f"Ndugu {username} kesho kutwa ni siku ya kutoa chanjo ya {chanjo_name} kwa {AinaYaKuku}.\nSasa unaweza kuagiza vifaranga bora kutoka Oceanchick, simu 0623046899"
            #message = f"Hellow! {username}, kesho kutwa ni siku ya kuwapatia kuku  {chanjo_name} kwa {AinaYaKuku} wenye umri wa siku {UmriWaKukuKwaSiku}. \n Kwa msaada wa kitaalamu juu ya jinsi ya kutoa chanjo hii na kutatua changamoto za kiufugaji, tafadhali piga simu: 0759536085. \n Tunajivunia kuwa na Mfugaji Smart, jukwaa ambalo linaogeza ufanisi wa ufugaji nchini."
            phone_number = f"255{phone}"
...
def Tuma_KumbushoUsafishajiBanda_Kwa_Wote(request):
    ...
    for user in users:
        ...
        if Awamu == 'Maramoja tu':
            ...
            #mwanzo wa kutuma sms
            message = f"Ndugu {username} Kesho ni siku ya kufanya usafi bandani.\nSasa unaweza kuagiza vifaranga bora kutoka Oceanchick, simu 0623046899"
            #message = f"Hello! {username}, kesho ni siku ya kufanya usafi wa banda lako ili kuimarisha afya ya kuku wako na kudhibiti magonjwa yanayoepukika kwa kuzingatia usafi. \n Ikiwa umechagua kupokea kumbusho hili kwa kujirudia, basi utapata ujumbe wa kumbusho awamu ijayo. \n \n Kampuni ya WASTE-PROTEIN TECH LTD wanakuletea lishe mbadala kwa kuku ambao ni wadudu aina ya Black Soldier Fly Larvae (BSFL). \n Wadudu wenye protini nyingi ambayo huongeza ukuaji kwa mifugo kama vile kuku, samaki, na wengine wanaofugwa. \n Ni rahisi kufuga wadudu hawa pia unaweza kuagiza wadudu walioandaliwa kitaalamu ili kuchanganya kwenye chakula. \n Mawasiliano zaidi piga simu: 0657378672 \n Mfugaji Smart - Fuga Kidijitali."
            phone_number = f"255{phone}"
...
def Tuma_KumbushoLaUatamiajiWaMayai_Kwa_Wote(request):
    ...
    for user in users:
        ...
        if time_left == 0:
            ...
            #mwanzo wa kutuma sms
            message = f"Ndugu {username} Mayai {KiasiChaMayai}, {JinaLaUlipoYatoaMayai} ya {AinaYaNdege} yataanguliwa siku 3 baada ya leo.\nSasa unaweza kuagiza vifaranga bora kutoka Oceanchick, simu 0623046899"
            #message = f"hellow! {username}, leo ni siku ya {leo_ni_siku_ya}, siku tatu zimebaki kabla ya mayai yako kuanguliwa na kua vifaranga. \n Uliweka mayai {KiasiChaMayai} ya {AinaYaNdege} yaliyokuwa na alama {JinaLaUlipoYatoaMayai}, mayai haya yalikuwa na siku {SikuYaNgapiTokaKuatamiwa} tangu kuanza kuatamiwa wakati unaweka kumbusho hili uatamiaji uliofanywa na {Kifaa} \n Jina la mteja  {JinaLaUlipoYatoaMayai}. \n Mwenye simu namba {NambaYakeYaSimu} \n Tafadhali jiandae mapema kupokea vifaranga wakati wa kuanguliwa \n Kwa msaada, tafadhali wasiliana nasi: 0759536085. \n Mfugaji Smart, Fuga kidijitali."
            phone_number = f"255{phone}"
...
def Tuma_KumbushoLaMabadilikoYaLishe_Kwa_Wote(request):
    ...
    for user in users:
        ...
        if (time_left == 0) and ((AinaYaKuku == "Kuku aina ya Kroila" and UmriWaKukuKwaSiku >= 0 and UmriWaKukuKwaSiku <= 7) or (AinaYaKuku == "Kuku wa Mayai (Layers)" and UmriWaKukuKwaSiku >= 0 and UmriWaKukuKwaSiku <= 7) or (AinaYaKuku == "Kuku aina ya Sasso" and UmriWaKukuKwaSiku >= 0 and UmriWaKukuKwaSiku <= 7) or (AinaYaKuku == "Kuku aina ya Tanbro" and UmriWaKukuKwaSiku >= 0 and UmriWaKukuKwaSiku <= 7) or (AinaYaKuku == "Kuku aina ya Kenbro" and UmriWaKukuKwaSiku >= 0 and UmriWaKukuKwaSiku <= 7)):
            message = f"Ndugu {username} badili lishe ya kuku wa {KundiLaKukuWake} kutoka starter feed, anza kutumia Grower feed.\nSasa unaweza kuagiza vifaranga bora kutoka Oceanchick, simu 0623046899"
            recipient_list = [email]
        ...
        if (time_left == 0) and ((AinaYaKuku == "Kuku aina ya Kroila" and UmriWaKukuKwaSiku >= 29 and UmriWaKukuKwaSiku <= 35) or (AinaYaKuku == "Kuku wa Mayai (Layers)" and UmriWaKukuKwaSiku >= 29 and UmriWaKukuKwaSiku <= 35) or (AinaYaKuku == "Kuku aina ya Sasso" and UmriWaKukuKwaSiku >= 29 and UmriWaKukuKwaSiku <= 35) or (AinaYaKuku == "Kuku aina ya Tanbro" and UmriWaKukuKwaSiku >= 29 and UmriWaKukuKwaSiku <= 35) or (AinaYaKuku == "Kuku aina ya Kenbro" and UmriWaKukuKwaSiku >= 29 and UmriWaKukuKwaSiku <= 35)):
            message = f"Ndugu {username} badili lishe ya kuku wa {KundiLaKukuWake} kutoka Grower feed, anza kutumia Layer feed.\nSasa unaweza kuagiza vifaranga bora kutoka Oceanchick, simu 0623046899"
            recipient_list = [email]
        ...
        if (time_left == 0) and (AinaYaKuku == "Kuku aina ya Broila (kuku wa nyama)" and UmriWaKukuKwaSiku >= 15 and UmriWaKukuKwaSiku <= 21):
            message = f"Ndugu {username} badili lishe ya kuku wa {KundiLaKukuWake} kutoka Grower feed, anza kutumia Finisher feed.\nSasa unaweza kuagiza vifaranga bora kutoka Oceanchick, simu 0623046899"
            recipient_list = [email]
...
def AllMyUser(request):
    ...
    if request.method == 'POST':
        ...
        if form['export_to_CSV'].value() == True:
            ...
            response['content-Disposition'] = 'attachment; filename="Duka Lako.csv"'
            writer = csv.writer(response)
            writer.writerow(['Jina Kamili','Email', 'Namba Ya Simu', 'Anapoishi', 'Maelezo', 'Kampuni Yake','Mkoa', 'Tick Status', 'Siku Aliyojisajili'])
            instance = queryset
            for x in queryset:
                writer.writerow([x.username,x.email,x.phone, x.Location, x.Maelezo, x.company_name, x.Mkoa.JinaLaMkoa, x.TickStatus, x.date_joined])
            return response
            #ZINAISHIA HAPA ZA KUDOWNLOAD
...
def AddNewWatejaWote(request, id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            subject = "Mfugaji Smart"
            message = f"Hongera! {JinaLaMteja} Oda yako imepokelewa leo. Utapokea oda ya {HudumaJinaLaHuduma} ({Kiasi_Au_Idadi}) siku {SikuYaKupokea} baada ya leo.\nGharama: {HudumaTotalPrice}, Umelipia: {PaidAmount}, Deni: {Remained_Display_Value}\nMaelezo kamili ya mtoa huduma\nJina: {Mzalishajiusername}, Simu: {Mzalishajiphone}, Mkoa: {MzalishajiMkoa}, Wilaya: {MzalishajiWilaya}"
            ...
            subject = "Mfugaji Smart"
            message = f"Mteja {JinaLaMteja} ({phoneYaMteja}) amelipia oda ya {HudumaJinaLaHuduma} ({Kiasi_Au_Idadi}) leo. Atapokea baada ya siku {SikuYaKupokea}\nGharama: {HudumaTotalPrice}, Amelipia: {PaidAmount}, Deni: {Remained_Display_Value}, Mkoa: {MkoaWaMteja_name}, Wilaya: {WilayaYaMteja}"
...
@login_required(login_url='Mylogin_user')
def search_NotepadMatatizo_autocomplete(request):
    print(request.GET)
    #form = AvailableMedicinesForm()
    query_original = request.GET.get('term')
    search = Q(Tatizo__icontains=query_original)|Q(NambaYaTatizo__icontains=query_original)
    #queryset = Dozi.objects.filter(name__icontains=query_original)
    filters = NotepadMatatizo.objects.filter(search)
    mylist= []
    mylist += [x.Tatizo for x in filters]
    return JsonResponse(mylist, safe=False)


@login_required(login_url='Mylogin_user')
def search_NotepadMikoa_autocomplete(request):
    print(request.GET)
    #form = AvailableMedicinesForm()
    query_original = request.GET.get('term')
    search = Q(JinaLaMkoa__icontains=query_original)|Q(NambaYaMkoa__icontains=query_original)
    #queryset = Dozi.objects.filter(name__icontains=query_original)
    filters = NotepadMikoa.objects.filter(search)
    mylist= []
    mylist += [x.JinaLaMkoa for x in filters]
    return JsonResponse(mylist, safe=False)
...
@login_required(login_url='Mylogin_user')
def search_MatatizoYaWateja_autocomplete(request):
    print(request.GET)
    #form = AvailableMedicinesForm()
    query_original = request.GET.get('term')
    search = Q(JinaLaMteja__icontains=query_original) 
    #queryset = Dozi.objects.filter(name__icontains=query_original)
    filters = MatatizoYaWateja.objects.filter(search)
    mylist= []
    mylist += [x.JinaLaMteja for x in filters]
    return JsonResponse(mylist, safe=False)
...
def AddNewMatatizoYaWateja(request):
    
    form = MatatizoYaWatejaCreateForm()
    if request.method == "POST":
        JinaLaMteja = request.POST.get('JinaLaMteja')
        phone = request.POST.get('phone')
        email = request.POST.get('email')
        ...
        form = MatatizoYaWatejaCreateForm(request.POST or None, files=request.FILES)
        ...
        if form.is_valid():
            ...
            messages.success(request, f"umefanikiwa kuongeza tatizo jipya la {JinaLaMteja}")
            return redirect('AddNewMatatizoYaWateja')

        messages.success(request, f"Kuna tatizo kwenye kuongeza tatizo la {JinaLaMteja}")
        return redirect('AddNewMatatizoYaWateja')
    ...
    return render(request, 'MyTemplatesApp/AddNewMatatizoYaWateja.html',context)
...
def UpdateNewMatatizoYaWateja(request, id):
    x = MatatizoYaWateja.objects.get(id=id)
    
    form = MatatizoYaWatejaCreateForm(instance=x)
    if request.method == "POST":
        JinaLaMteja = request.POST.get('JinaLaMteja')
        phone = request.POST.get('phone')
        email = request.POST.get('email')
        ...
        form = MatatizoYaWatejaCreateForm(request.POST or None, files=request.FILES, instance=x)
        ...
        if form.is_valid():
            ...
            messages.success(request, f"umefanikiwa kubadilisha taarifa za {JinaLaMteja}")
            return redirect('AllMatatizoYaWateja')

        messages.success(request, f"Kuna tatizo kwenye ubadilishaji wa taarifa za {JinaLaMteja}")
        return redirect('AddNewMatatizoYaWateja', id=id)
    ...
    return render(request, 'MyTemplatesApp/UpdateNewMatatizoYaWateja.html',context)
...
@login_required(login_url='Mylogin_user')
def AllMatatizoYaWateja(request):
    


    

    form = MatatizoYaWatejaSearchForm(request.POST or None)
    # x= datetime.now()
    # current_date = x.strftime('%d-%m-%Y %H:%M')
    

    queryset = MatatizoYaWateja.objects.all(
    ...
    count_wanaotumiwa = MatatizoYaWateja.objects.all(
            #Status__Status__icontains='Approved'
    ...
    if request.method == 'POST':
        ...
        queryset = MatatizoYaWateja.objects.filter(
                                        JinaLaMteja__icontains=form['JinaLaMteja'].value(),
        ...
        if form['export_to_CSV'].value() == True:
            response = HttpResponse(content_type='text/csv')
            response['content-Disposition'] = 'attachment; filename="MatatizoYaWateja.csv"'
            writer = csv.writer(response)
            writer.writerow(['Jina La Mteja','Namba Ya Simu','Email Ya Mteja','Mkoa','Wilaya','Jina La Tatizo', 'Maelezo', 'Siku Iliyosajiliwa'])
            instance = queryset
            for x in queryset:
                writer.writerow([x.JinaLaMteja,x.phone,x.email,x.Mkoa,x.Wilaya,x.JinaLaTatizo, x.Message, x.Created])
            return response
            #ZINAISHIA HAPA ZA KUDOWNLOAD
    ...
    return render(request, 'MyTemplatesApp/AllMatatizoYaWateja.html',context)
...
def deleteMatatizoYaWateja(request, id):
    x = MatatizoYaWateja.objects.get(id=id)
    x.delete()
    messages.success(request, f"Umefanikiwa kufuta tatizo la {x.JinaLaMteja} ")
    return redirect('AllMatatizoYaWateja')
...
def TatizoStatsView(request):
    # Count occurrences of each problem (JinaLaTatizo)
    queryset = MatatizoYaWateja.objects.values('JinaLaTatizo').annotate(count=Count('JinaLaTatizo')).order_by('-count')
    
    # Count occurrences of each region (Mkoa) where the problems occur
    mikoa_counts = MatatizoYaWateja.objects.values('Mkoa').annotate(count=Count('Mkoa')).order_by('-count')
    ...
    if form['export_to_CSV'].value() == True:
        ...
        response['content-Disposition'] = 'attachment; filename="MatatizoYaWateja.csv"'
        writer = csv.writer(response)
        writer.writerow(['Jina La Tatizo', 'Limetokea Mara Ngapi'])
        instance = queryset
        for x in queryset:
            writer.writerow([x['JinaLaTatizo'], x['count']]) 
        return response
        #ZINAISHIA HAPA ZA KUDOWNLOAD

    context = {
        'queryset': queryset,
        'mikoa_counts': mikoa_counts,
        #'page':page,
        'form':form,
    }
    
    return render(request, 'MyTemplatesApp/TatizoStatsView.html', context)



def MikoaStatsView(request):
    queryset = MatatizoYaWateja.objects.values('Mkoa').annotate(count=Count('Mkoa')).order_by('-count')  
    ...
    if form['export_to_CSV'].value() == True:
        ...
        response['content-Disposition'] = 'attachment; filename="MatatizoYaWateja.csv"'
        writer = csv.writer(response)
        writer.writerow(['Mkoa', 'Limetokea Mara Ngapi'])
        instance = queryset
        for x in queryset:
            writer.writerow([x['Mkoa'], x['count']]) 
        return response
        #ZINAISHIA HAPA ZA KUDOWNLOAD
    ...
    return render(request, 'MyTemplatesApp/MikoaStatsView.html', context)


def WilayaStatsView(request, mkoa_name):
    # Count occurrences of each 'Wilaya' within a specific 'Mkoa'
    queryset = MatatizoYaWateja.objects.filter(Mkoa=mkoa_name).values('Wilaya').annotate(count=Count('Wilaya')).order_by('-count')
    
    form = MatatizoYaWatejaSearchForm(request.POST or None)

    # Handle CSV export for Wilaya stats
    if form['export_to_CSV'].value() == True:
        response = HttpResponse(content_type='text/csv')
        response['Content-Disposition'] = f'attachment; filename="{mkoa_name}_WilayaStats.csv"'
        writer = csv.writer(response)
        writer.writerow(['Wilaya', 'Limetokea Mara Ngapi'])
        
        for x in queryset:
            writer.writerow([x['Wilaya'], x['count']]) 
        return response
    ...
    return render(request, 'MyTemplatesApp/WilayaStatsView.html', context)


def TatizoNdaniYaWilayaStatsView(request, mkoa_name, wilaya_name):
    # Count occurrences of each 'JinaLaTatizo' within a specific 'Wilaya' in a specific 'Mkoa'
    queryset = MatatizoYaWateja.objects.filter(Mkoa=mkoa_name, Wilaya=wilaya_name).values('JinaLaTatizo').annotate(count=Count('JinaLaTatizo')).order_by('-count')
    
    form = MatatizoYaWatejaSearchForm(request.POST or None)

    # Handle CSV export for Tatizo stats
    if form['export_to_CSV'].value() == True:
        response = HttpResponse(content_type='text/csv')
        response['Content-Disposition'] = f'attachment; filename="{wilaya_name}_TatizoStats.csv"'
        writer = csv.writer(response)
        writer.writerow(['Jina La Tatizo', 'Limetokea Mara Ngapi'])
    ...
    return render(request, 'MyTemplatesApp/TatizoNdaniYaWilayaStatsView.html', context)
...
def InformUsersPage(request):
    ...
    count_watumiaji_wote = MyUser.objects.all(
            #Tick__icontains="Ndio Anastahili"
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            Title = request.POST.get('Title')
            SentMessage = request.POST.get('SentMessage')
            ...
            messages.success(request,f"Ujumbe umetumwa kikamilifu kwa watumiaji wote")
    ...
    return render(request, 'MyTemplatesApp/InformUsersPage.html', {"form":form,"count_watumiaji_wote":count_watumiaji_wote, "name":name})
